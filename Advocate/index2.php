      ...
      <table width="960" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <div class="contentWrapOffices">
            ...
            <div class="content">
              <p><a href="../Advocate/pwdch.php">Change Password </a></p>
              <h3>Think Bing Facebook Administrator</h3>
              <p>&nbsp;</p>
              <form id="form1" name="form1" method="post" action="../Advocate/checkpwd.php">
                <label>
                ...
                <h5 align="left"> Please Enter Correct Username and Password ...</h5>
                <p>&nbsp;</p>
                <p align="left">
                  <label for="Go"></label>
